...
# ===== Global Variable Store API =====

_vars_router = APIRouter(prefix="/api/variables", tags=["variables"])
...
async def set_variable(key: str, request: Request):
...
# Export the vars router so main.py can include it
vars_router = _vars_router

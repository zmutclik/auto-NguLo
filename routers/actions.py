...
async def create_action(script_id: int, data: ActionCreate):
    ...
    cursor = await db.execute(
        """INSERT INTO actions (
            ...
            template_path, match_threshold, retry_count, retry_delay_ms,
        ...
        (
            ...
            data.template_path, data.match_threshold, data.retry_count, data.retry_delay_ms,
...
async def update_action(script_id: int, action_id: int, data: ActionUpdate):
    ...
    field_map = {
        ...
        "template_path": data.template_path, "match_threshold": data.match_threshold,
